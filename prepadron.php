...
<head>
  ...
  <title>DATA SKATE - Padrón Usuarios</title>
</head>
...
<body class="">
  ...
  <script>
    ...
    var valorFiltro = localStorage.mostrarFiltro_prepadron;
    ...
    function mostrarFiltros() {
      var mostrarFiltro_prepadron = 1;
      localStorage.mostrarFiltro_prepadron = mostrarFiltro_prepadron;
      $('#mostrarFiltros').hide();
      $('#ocultarFiltros').show();
