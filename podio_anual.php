...
<head>
  ...
  <title>DATA SKATE - Podio Anual</title>
</head>
...
<body class="">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="col-lg-12 modal-body">
          ...
          <p class="ml-4 font-weight-bold text-danger">Usted es un ADMINISTRADOR y podrá eliminar TODOS o SOLO los Podios Anuales que seleccione!!</p>
                ...
                <div class="accordion-body">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-8 form-floating">
                      <input name="institucion" type="text" class="form-control" id="consultarInstitucion" placeholder="Club" required />
                ...
                <div class="accordion-body">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 form-floating">
                      <input name="disciplina" type="text" class="form-control" id="consultarDisciplina" placeholder="Dicciplina" required />
                      <label for="floatingInput">Disciplina</label>
                    </div>

                    <div class="form-group col-md-6 form-floating">
                      <input name="divisional" type="text" class="form-control" id="consultarDivisional" placeholder="Divisional" required />
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 form-floating">
                      <input name="eficiencia" type="text" class="form-control" id="consultarEficiencia" placeholder="Eficiencia" required />
                      <label for="floatingInput">Eficiencia</label>
                    </div>

                    <div class="form-group col-md-6 form-floating">
                      <input name="categoria" type="text" class="form-control" id="consultarCategoria" placeholder="Categoria" required />
  ...
  <script>
    ...
    function eliminarTodos() {
      ...
      Swal.fire({
        title: 'Esta seguro?',
        text: "Esta por eliminar datos PODIOS ANUALES. A continuación se le solicitará su password y luego seleccionar el Podio Anual a eliminar!!!",
        icon: 'warning',
