...
switch ($opcion) {
    ...
    case 5:
        ...
        if ($licenciaVacia == 0) {
            ...
            $sql = "INSERT INTO patinadores (dnipatinador, fechanacpatinador, nombrepatinador, apellidopatinador, sexopatinador, 	tipolicencia, emailpatinador, telefonopatinador, domiciliopatinador, nacionalidadpatinador, provinciapatinador, localidadpatinador, cppatinador, funcionpatinador, partidopatinador, valorLicencia, 	pagoLicencia, nombrepadre, dnipadre, nombremadre, dnimadre, cuit, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta, dnimod, nombremod, apellidomod, cuitmod, institucionmod, fechamod) SELECT dnipatinador, fechanacpatinador, nombrepatinador, apellidopatinador, sexopatinador, 	tipolicencia, emailpatinador, telefonopatinador, domiciliopatinador, nacionalidadpatinador, provinciapatinador, localidadpatinador, cppatinador, funcionpatinador, partidopatinador, valorLicencia, 	pagoLicencia, nombrepadre, dnipadre, nombremadre, dnimadre, cuit, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta, dnimod, nombremod, apellidomod, cuitmod, institucionmod, fechamod  FROM prepatinadores WHERE prepatinadores.cuit = $cuit";
            if (mysqli_query($conexion, $sql)) {
