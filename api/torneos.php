...
if (isset($_POST['opcion'])) {
    ...
    $estadoelementos = $_POST['estadoelementos'];
    $valor = $_POST['valor'];
}
...
switch ($opcion) {
    case 0:
        // consulta SQL
        $sql = "SELECT torneo.nombretorneo, FORMAT(torneo.valor,2) AS valor, torneo.estadotorneo, torneo.estadoelementos, torneo.id FROM torneo;";
    ...
    case 2:
        ...
        if (isset($id)) {
            ...
            $sql = "UPDATE torneo SET estadotorneo = '$estadotorneo', estadoelementos = '$estadoelementos', valor='$valor', dnimod = '$dnimod', nombremod = '$nombremod', apellidomod = '$apellidomod', cuitmod = '$cuitmod', institucionmod = '$institucionmod', fechamod = '$fechamod' WHERE torneo.id = $id;";
    ...
    case 4:
        ...
        if ($numeroRegistros == 0) {
            ...
            $sql = "INSERT INTO torneo (nombretorneo, valor, estadotorneo, estadoelementos, fechatorneo, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta) VALUES ('$torneo', '$valor', '$estadotorneo', '$estadoelementos', '', '$dnialta', '$nombrealta', '$apellidoalta', '$cuitalta', '$institucionalta', '$fechaalta')";
