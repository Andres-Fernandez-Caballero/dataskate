<?php
include('modulos/encabezado_invitado.php');
?>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="col-lg-12">
          ...
          <h6 class="mb-3" id="institucionMusica1"></h6>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="col-lg-12">
          ...
          <h6 class="mb-3" id="institucionMusica2"></h6>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="col-lg-12">
          ...
          <h6 class="mb-3" id="institucionElementos"></h6>
  ...
  <script>
    ...
    var listar = function() {
      ...
      table = $("#tablaClientes").DataTable({
        ...
        columns: [{
          ...
          },
          {
            ...
            render: function(data, type) {
              ...
              if (data !== null) {
                return '<audio controls title="' + data + '">' + '<source src="' + data + '" type="audio/mpeg">' + 'Tu navegador no soporta el elemento de audio.</audio>';
                return data
              };
            }
          },
          ...
          },
          {
            ...
            render: function(data, type) {
              ...
              if (data !== null) {
                return '<a href="' + data + '" target="_blank" title="' + data + '"><button type="button" class="btn btn-outline-secondary btn-circle btn-sm" style="font-size: 40px !important;"><i class="fas fa-file-pdf"></i></button></a>' + '<a href="' + data + '" download="' + data + '"> <button type="button" class="btn btn-warning btn-circle btn-sm"><i class="fas fa-arrow-alt-down"></i></button></a>';
                return data
              };
            }
          },
        ...
        columnDefs: [{
          ...
          },
          {
            ...
            targets: [0, 2, 3, 14, 15, 16, 17, 20, 21, 22],
          },
          {
            // oculta columnas
      ...
      $('#tablaClientes tbody').on("click", "button.btnEdit1", function() {
        ...
        consultarMusica1(id, nombre, apellido, disciplina, institucion, musica1);
      });

      // Trae los datos de MUSICA 2 cuando se presiona el boton edit
      $('#tablaClientes tbody').on("click", "button.btnEdit2", function() {
        ...
        consultarMusica2(id, nombre, apellido, disciplina, institucion, musica2);
      });

      // Trae los datos de DECLARACION cuando se presiona el boton edit
      $('#tablaClientes tbody').on("click", "button.btnEdit3", function() {
        ...
        // console.log(nombre + " " + apellido + " " + disciplina + " " + musica2 + " " + id)
        consultarElementos(id, nombre, apellido, disciplina, institucion, elementos);
      });
      ...
      $('#tablaClientes tbody').on("click", "button.btnDel1", function() {
        ...
        // console.log(nombre + " " + apellido + " " + disciplina + " " + musica2 + " " + id)
        confirmarBorrarDato(id, nombre, apellido, disciplina, institucion, dato, opcion);
      });

      // Trae los datos de MUSICA 2 cuando se presiona el boton Borrar
      ...
      // Trae los datos de DECLARACION cuando se presiona el boton Borrar
    ...
    function consultarMusica1(id, nombre, apellido, disciplina, institucion, dato) {
      ...
      document
        .getElementById('institucionMusica1')
        .innerHTML = "Institucion: " + institucion
    }
    // === FIN CONSULTAR DATOS ===

    // === CONSULTAR DATOS MUSICA 2 ===
    function consultarMusica2(id, nombre, apellido, disciplina, institucion, musica2) {
      ...
      document
        .getElementById('institucionMusica2')
        .innerHTML = "Institucion: " + institucion
    }
    // === FIN CONSULTAR DATOS ===

    // === CONSULTAR DATOS ELEMENTOS ===
    function consultarElementos(id, nombre, apellido, disciplina, institucion, elementos) {
      ...
      document
        .getElementById('institucionElementos')
        .innerHTML = "Disciplina: " + institucion
    }
    // === FIN CONSULTAR DATOS ===
    ...
    var valorFiltro = localStorage.mostrarFiltro_musica;
    ...
    function mostrarFiltros() {
      var mostrarFiltro_musica = 1;
      localStorage.mostrarFiltro_musica = mostrarFiltro_musica;
      $('#mostrarFiltros').hide();
      $('#ocultarFiltros').show();
