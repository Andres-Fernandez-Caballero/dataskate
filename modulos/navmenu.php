    ...
    <div class="navbar-wrapper">
        <div class="navbar-content scroll-div">
            ...
            <ul class="nav pcoded-inner-navbar">
                ...
                <?php if ($user['acceso'] == 'administrador') : ?>
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link">
                            ...
                            <span class="pcoded-mtext">DATA SKATE</span>
                        </a>
                        <ul class="pcoded-submenu">
                            ...
                            <li class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li><a href="music_elements_buenafe.php">Musica y Declaraciones</a></li>
                ...
                <?php if ($user['acceso'] == 'tecnico' || $user['acceso'] == 'delegado') : ?>
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link">
                            <span class="pcoded-micon"><i class="feather icon-box"></i></span>
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li><a href="users_music_elements_buenafe.php">Musica y Declaraciones</a></li>
                ...
                <!-- Acceso al menu para Invitados -->
                <?php if ($user['acceso'] == 'invitado') : ?>
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link">
                            <span class="pcoded-micon"><i class="feather icon-box"></i></span>
                            <span class="pcoded-mtext">INVITADOS</span>
                        </a>
                        <ul class="pcoded-submenu">
                            <li><a href="zinvitado_music_elements_buenafe.php">Musica y Declaraciones</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
            </ul>
