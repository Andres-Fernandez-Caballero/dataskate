...
<body>
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <form action="index.php" method="post">
              <div class="card-body">
                <h4 class="mb-3 f-w-400">Login DATA SKATE</h4>
                <hr />
  ...
  <script>
    ...
    localStorage.mostrarFiltro_musica = 0;
    ...
    localStorage.users_mostrarFiltro_buenaFe = 0;
    localStorage.mostrarFiltro_users_musica = 0;
  </script>
</body>
